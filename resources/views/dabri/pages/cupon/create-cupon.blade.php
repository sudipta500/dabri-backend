...
<div class="card col-5 m-auto">
    <div class="card-header">
        <h5 class="card-title mb-0">Cupon</h5>
    </div>
    <div class="card-body" >
        <form action="" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="cupon_code" placeholder="Enter new cupon Name" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="value" placeholder="Enter cupon value" required>
