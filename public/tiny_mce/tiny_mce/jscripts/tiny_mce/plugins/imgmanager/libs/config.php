...
$SITEURL="https://www.goldcoastiphonerepairs.com/";
...
defined('WEB_BASE') || define('WEB_BASE',"../upload" );



//defined('WEB_BASE') || define('WEB_BASE', $SITEURL."/upload" );
...
defined('UPLOADS_URL') || define('UPLOADS_URL', $SITEURL."upload" );
