...
Route::get('/cart',[CartController::class,'cartView'])->middleware('user_auth');
Route::post('/cart',[CartController::class,'cartOperation'])->middleware('user_auth');
Route::post('/cart-update',[CartController::class,'cartUpadte'])->middleware('user_auth');
Route::post('/cart-checkout',[CheckoutController::class,'cartUpadte'])->middleware('user_auth');
...
Route::post('/orderitem',[orderItemController::class,'orderItem'])->middleware('user_auth');
...
Route::get('/my-profile', function () {
    return view('user.pages.my_profile');
})->name('my-profile');
